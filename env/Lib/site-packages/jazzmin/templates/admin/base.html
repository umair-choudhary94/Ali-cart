                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column {{ jazzmin_ui.sidebar_list_classes }}" data-widget="treeview" role="menu" data-collapsible="false">
                            ...
                            <li class="nav-item">
                                <a href="{% url 'useradmin:dashboard_statistics' %}" class="nav-link">
                                    <i class="nav-icon fas fa-chart-bar"></i>
                                    <p>{% trans 'Dashboard Statistics' %}</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{% url 'useradmin:add-multiple-products' %}" class="nav-link">
                                    <i class="nav-icon fas fa-plus"></i>
                                    <p>{% trans 'Add Multiple Products' %}</p>
                                </a>
                            </li>
